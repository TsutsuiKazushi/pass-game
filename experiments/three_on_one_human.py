...
class ThreeOnOne:
    ...
    def __init__(self, accel_defender, accel_attacker1, accel_attacker2, accel_attacker3, accel_ball=3, \
                 ...
                 damping=0.25, dt=0.1, max_step=9999):
    ...
    def step(self, obs_d, obs_a1, obs_a2, obs_a3, action_d, action_a1, action_a2, action_a3, num_step):
        ...
        # ==== For human ==== 
        abs_u_a1, abs_u_b_a1, next_pass_a1, next_with_b_a1, action_a1 = get_abs_ball_u_human(action_a1, self.pos_a1, self.pos_a2, self.pos_a3, self.pos_d, \
                                                                                  self.with_b_a1, self.pass_a1, self.to_a1, self.to_a2, self.to_a3, self.pos_b, self.vel_b, self.pass_noise1)
        # =================
        ...
        reward_d = get_reward_defender(next_pos_d, next_pos_d)
...
def get_abs_ball_u_human(action, abs_own_pos, abs_mate1_pos, abs_mate2_pos, abs_adv_pos, with_b_own, pass_own, to_own, to_mate1, to_mate2, abs_ball_pos, abs_ball_vel, pass_noise):
